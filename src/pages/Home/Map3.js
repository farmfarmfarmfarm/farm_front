    ...
    script.innerHTML = `         
        function initTmap() {
            ...
            // 4. 경로탐색 API 사용요청
              ...
              var prtcl;
              var headers = {};
              var unq_tmak = "l7xxaf713fc5b92c4e2ca86a68011119ad55";
                  ...
                  success:function(response){
                    ...
                    for (var i = 0; i < newData.length; i++) {
                      ...
                      if(type == "Point"){
                        ...
                        var startPt,endPt;
                        for (var j = 0; j < mData.geometry.coordinates.length; j++) {                              var linePt = new Tmapv2.LatLng(mData.geometry.coordinates[j][1],mData.geometry.coordinates[j][0]);
                          PTbounds.extend(linePt);
                        }
                      }
                    }
...
//           $.ajax({
//               method:"POST", 
//               headers :{'appKey' : 'l7xxaf713fc5b92c4e2ca86a68011119ad55'},
//               url:"https://apis.openapi.sk.com/tmap/routes?version=1&format=json",
//               async:false,
//               data:{ 
//                 startX : startX,
