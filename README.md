...
## 소개
코로나19로 인해 신체적/심리적 문제를 겪고 있는 사람들이 많아졌다.<br/>이 문제를 해결하기 위한 여러가지 방안이 등장하고 있었고 그 중 치유농업에 관심을 갖게 되었다.

‘치유농업 연구개발 및 육성에 관한 법률(이하 치유농업법)’이 국회를 통과할 만큼 치유농업에 대해 국가가 관심을 가지며 치유농업을 알리고 있지만, 치유농업의 개념조차도 인식하지 못하는 사람들이 많다. 이에 농업 활동으로 힐링하는 시간을 얻을 수 있도록 도와주는 서비스를 기획하였다.

Therapia는 라틴어로 '치료'라는 뜻을 담고 있다. 우리 서비스에서 치료는 두 가지의 의미를 담고 있다.<br/>첫 번째는 '치유농장'을 통한 심적인 치료를 할 수 있다는 의미이고, 두 번째는 '작물 진단'을 통한 신체적인 치료를 할 수 있다는 의미이다. 


## 기능 상세
<img width="250px" src="https://user-images.githubusercontent.com/81412212/182316037-a0e20f64-fc8d-4235-a18a-c938e908f435.png"><img width="250px" src="https://user-images.githubusercontent.com/81412212/182316043-871c926e-b197-45bf-a2f2-b4634f4154dd.png">

 가고 싶은 지역을 검색하여 지정한다. <br/>
 해당 지역에서 운영되고 있는 농장들을 볼 수 있다. <br/>
 ‘주말 농장’, ‘치유 농장’, ‘체험 농장’ 중 관심 있는 유형의 농장을 선택하면 해당 농장만 볼 수 있다. <br/>
 농장들의 위치를 지도를 통해 바로 확인할 수 있고 상세 설명은 지도 아래에서 확인 가능하다. <br/>
 상세 설명 카드들은 좌우 스크롤로 이동하며 볼 수 있다.
 
 
 <img width="250px" src="https://user-images.githubusercontent.com/81412212/182316060-abcac787-2752-468e-bae9-8eef2e23194e.png">

  자신의 증상에 가까운 것들을 체크하면 그 증상에 맞는 효능 작물을 소개해주는 서비스를 제작 
 또 작물들로 음식을 만들 수 있게 원하는 작물을 선택하면 효능, 제철 시기, 보관방법, 재료, 레시피 정보를 제공
 
 
 
  
 사람들이 농장을 알아볼 때 거리와 평점을 중요시 생각할 것
 그 아이디어를 바탕으로 농장을 선택했을 시 그 농장에 대한 정보와 함께 아래에 도넛차트로 추천도를 보여줌
...
- 노트북, 컴퓨터 환경보다 모바일을 통한 정보전달이 익숙한 사용자들을 위해 모바일 화면에 맞게 제작
...
## 활용 데이터
 ...
 2) 공공데이터포털 - 서울시 주말농장 현황 (Excel 데이터를 활용해 데이터 획득 후 파이썬을 이용해 알맞게 가공)(https://www.data.go.kr/data/15047308/fileData.do)3) 공공데이터포털 – 농촌진흥청_치유농장 (오픈 API를 활용해 AJAX 방식으로 치유농장 데이터를 획득)(https://www.data.go.kr/data/15081306/openapi.do)
